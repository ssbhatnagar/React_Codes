...
// BELOW IS V1 OF THE FORM EXAMPLE
// HERE WE HAVE USED MULTIPLE STATES TO MANAGE THE FORM DATA
...
// BELOW IS V2 OF THE FORM EXAMPLE
// this is a simpler version of form with less fields but covering all 4 types of form elements
// input field, radio button, checkbox, dropdown 
// state management for each form element is done using separate useState hooks
// in new version we will see how to manage form state using single useState hook with object

// function FormApp() {
//   const [name, setName] = useState("");
//   const [standard, setStandard] = useState("");
//   const [subjects, setSubjects] = useState([]); // for checkbox
//   const [house, setHouse] = useState("");
...
//           <div>
//             <fieldset>
//               <legend>Select your standard</legend>
//               <label>
//                 <input
//                   type="radio"
//                   value="10th"
...
//                   type="checkbox"
//                   value="Hindi"
//                   checked={subjects.includes("Hindi")}
//                   onChange={(e) => handleCheckbox(e.target.value)}
//                 ></input>
//                 Hindi
//               </label>
...
// BELOW IS V3 OF THE FORM EXAMPLE
// here we will manage the form state using single useState hook with object
            ...
            <fieldset>
              ...
              <label>
                <input
                  type="radio"
                  value="10th"
                  checked={formData.standard === "10th"}
            ...
            <fieldset>
              ...
              <label>
                <input
                  type="checkbox"
                  value="Hindi"
                  checked={formData.subjects.includes("Hindi")}
                  onChange={(e) => handleCheckbox(e.target.value)}
                />
                Hindi
              </label>
